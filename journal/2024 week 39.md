...
* At the interal surface: $`k\times A/L = 0.3 \times 20.8e^{-4}/1e^{-2} = 0.0924 \, W/K`$;
* At the external surface: $`k\times A/L = 0.3 \times 77e^{-4}/1e^{-2} = 0.231 \, W/K`$;
...
$`Q = (k \times A / L) \times \Delta T = 0.1848 \times 65 = 12.012\, W`$.
