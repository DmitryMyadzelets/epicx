...
$`Q = 5.67 \times 10^{-8} \times 0.95 \times 77 \times 10^{-4} \times (298^4 - 233^4) = 2.05 \, W`$.

With aluminium foil:

$`Q = 5.67 \times 10^{-8} \times 0.04 \times 77 \times 10^{-4} \times (298^4 - 233^4) = 0.0863 \, W`$.
...
$`4.1476 \times 10^{-10} \times T_{surface}^4 + 0.231 \times T_{surface} - 57.094 = 0`$;  
