# The CO<sub>2</sub> condenser (continued)
...
The past experiments have shown that the electrochemical cell made at DIFA/UNIBO is suitable to be used at target conditions: pressue 1M Pa, temperature -45 &deg;C. We now continue to design the CO<sub>2</sub> condenser to be used in the vacuum chamber at IMM.

The rationaly and initial design of the CO<sub>2</sub> condenser is described [earlier](</journal/2024 week 40.md>). For convenience, it's shown below.
...
The cap has inlets and outlets for the CO<sub>2</sub>, water and electrical connections.
